class Cylinder:
    ...
    def __init__(self,r=None,h=None,bottom_area=None,d=None,area_C=None,C=None,V=None,π='3.14'):
        self.r=r
    ...
    def Get_Surface(self):
        ...
        if self.h!=None:     #如果高有值
            if self.bottom_area!=None:     #如果底面积没有值
                self.Surface=self.Decimal(self.Lateral_area+(self.bottom_area*2))    #表面积就等于侧面积加上两个底面积
